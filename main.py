...
from runner import HilbertDiffusion
...
def parse_args_and_config():
    ...
    parser.add_argument(
        "--sample_type",
        default="sde",
        choices=["sde", "ode", "unipc_ode", "dpmpp_ode", "deis_ode", "tsit5_ode", "srk", None],
        help="sampling method (sde|ode|unipc_ode|dpmpp_ode|deis_ode|tsit5_ode|srk)",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Specific checkpoint step to use for sampling (e.g., 1000, 2000)",
    )
